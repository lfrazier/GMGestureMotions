...
- (IBAction)buttonPressed:(UIButton *)sender {
  if ([[trainingSetTextField text] isEqualToString:@""] ||
      [[gestureTextField text] isEqualToString:@""]) {
    [[[UIAlertView alloc] initWithTitle:@"Cannot Leave Blank"
                                message:@"Oops! Looks like you left a field blank. Fill it in!"
                               delegate:nil
  ...
  if ([gestureRecognizer isLearning]) {
    ...
    [gestureRecognizer startLearnMode:[trainingSetTextField text]
                           forGesture:[gestureTextField text]];
